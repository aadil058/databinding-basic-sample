...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.livedataViewmodelActivityButton.setOnClickListener {
            startActivity(Intent(this, LivedataViewModelActivity::class.java))
        }

        binding.observableViewmodelActivityButton.setOnClickListener {
            startActivity(Intent(this, ObservableViewModelActivity::class.java))
        }
    }
}
